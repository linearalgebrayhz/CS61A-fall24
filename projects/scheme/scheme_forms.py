...
def do_define_form(expressions, env):
    ...
    if scheme_symbolp(signature):
        ...
        # print("DEBUG:", type(expressions.rest))
        env.define(signature, scheme_eval(expressions.rest.first,env=env)) # exactly two elements
        return signature
        # END PROBLEM 4
        ...
        # BEGIN PROBLEM 10
        "*** YOUR CODE HERE ***"
        # flow: find function name, formals and body; create lambda; bindings; return symbols
        function_symbol = signature.first
        formals = signature.rest
        body = expressions.rest
        new_proc = do_lambda_form(Pair(formals,body),env)
        env.define(function_symbol,new_proc)
...
def do_quote_form(expressions, env):
    ...
    """
    # args of quote is just Pair(A, nil)
    validate_form(expressions, 1, 1)
    # BEGIN PROBLEM 5
    "*** YOUR CODE HERE ***"
    return expressions.first # just return the operand part of (quote ...) expression
    # END PROBLEM 5
...
def do_cond_form(expressions, env):
    ...
    while expressions is not nil:
        ...
        if is_scheme_true(test):
            # BEGIN PROBLEM 13
            "*** YOUR CODE HERE ***"
            if clause.first == 'else' and clause.rest == nil:
                return True

...
class Button:
    ...
    def press(self):
        ...
        self.pressed += 1
        "*** YOUR CODE HERE ***"
        if Button.caps_lock.pressed % 2:
            out = self.letter.upper()
        else:
            out = self.letter
        self.output(out)
        return self
...
class Keyboard:
    ...
    def __init__(self):
        self.typed = []
        self.keys = {key: Button(key, lambda a: self.typed.append(a)) for key in LOWERCASE_LETTERS}  # Try a dictionary comprehension!
